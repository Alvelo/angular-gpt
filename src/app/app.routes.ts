    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/orthograpy-page/orthograpy-page.component'
          ),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/pros-cons-stream/pros-cons-stream.component'
          ),
        data: {
...

      {
        path: 'assistant',
        loadComponent: () =>
          import('./presentation/pages/assistant-pages/assistant-pages.component'),
        data: {
